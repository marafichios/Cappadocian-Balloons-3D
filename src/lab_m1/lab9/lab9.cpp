...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    // Why does this happen? How can you solve it?
    {
        ...
        RenderSimpleMeshForTexture(meshes["sphere"], shaders["LabShader"], modelMatrix, mapTextures["earth"]);
    }

    {
        ...
        RenderSimpleMeshForTexture(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["crate"]);
    }

    {
        ...
        RenderSimpleMeshForTexture(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["random"]);
    }

    {
        ...
        RenderSimpleMeshForTexture(meshes["square"], shaders["LabShader"], modelMatrix, mapTextures["grass"]);
    }

    {
        ...
        RenderSimpleMeshForTexture(meshes["bamboo"], shaders["LabShader"], modelMatrix, mapTextures["bamboo"]);
    }
}
...
void Lab9::RenderSimpleMeshForTexture(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
